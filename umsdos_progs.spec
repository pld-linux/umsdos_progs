...
Pakiet umsdos_progs zwiera narzędzia do systemu plików UMSDOS, takie
jak umssync, udosctl i umssetup. umssync i inne narzędzia są potrzebne
do promocji katalogów do semantyki uniksowej oraz sprawdzania lub
poprawiania plików, które się rozsynchronizowały podczas nie używania
Linuksa.
...
Pakiet umsdos_progs-uvfat zwiera narzędzia do systemu plików UVFAT,
takie jak uvfatsync, uvfatctl i uvfatsetup. uvfatsync i inne narzędzia
są potrzebne do promocji katalogów do semantyki uniksowej oraz
sprawdzania lub poprawiania plików, które się rozsynchronizowały
podczas nie używania Linuksa.
